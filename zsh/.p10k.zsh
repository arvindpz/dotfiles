# Generated by Powerlevel10k configuration wizard on 2023-10-02 at 13:11 IST.
...
() {
  # I do not want bacgground colors for Status since there is too much red
  # I will set the BG color of the status bars as same as the terminal background
  local terminal_bg_color='#18242b'
  ...
  function my_git_formatter() {
    ...
    # Use '%7F' for white and '%0F' for black
    local       meta='%7F'
    local      clean='%7F'
    local   modified='%7F'
    local  untracked='%7F'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$terminal_bg_color
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=$terminal_bg_color
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=$terminal_bg_color
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=$terminal_bg_color
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=$terminal_bg_color
  ...
  typeset -g POWERLEVEL9K_RVM_BACKGROUND=197
