...
#+begin_src emacs-lisp
;; Set font
(set-face-attribute 'default nil :font "Fira Code" :foundry "Retina" :height 220 :weight 'light)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "Anonymous Pro for Powerline" :foundry "Regular" :height 200 :weight 'semilight)
